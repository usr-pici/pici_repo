...
function saveOptionsQuestion(idPregunta) {
    ...
    $.post(
        ...
        {
            idPregunta: idPregunta, //$('#idPregunta').val(),
...
function initTableQuestions(idFormulario) {
...
$(function () {
    ...
    $('#btnPreview').click(function () {
        window.open(URL_SITE + "formulario/preview/" + idFormulario, '_blank');
    })
